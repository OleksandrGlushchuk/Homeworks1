...
<<<<<<< HEAD
		m_shader.Init(L"source/shaders/emissive.hlsl", inputLayout, 7, true, false);
=======
		m_shader.Init(L"source/shaders/emissive.hlsl", inputLayout, 7);
>>>>>>> 4664866dd57b8b1f3aabfacf35a94f61e62a6e0a
